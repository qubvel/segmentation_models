...
print(next(iter(valid_dataloader))[0].shape)

# print the size of the first mask in valid_dataloader
print(next(iter(valid_dataloader))[1].shape)
...
with torch.no_grad():
    for batch in test_dataloader:
        ...
        for i, output in enumerate(outputs):
            ...
            cv2.imwrite(f"output_masks/{i}.png", output)
...
output_masks = os.listdir("output_masks")
